<template>
  <content-card>
    ...
    >
    <div>
      <h3 class="mb-2 text-lg font-semibold text-center">CanSat 2021</h3>
      <p>
      ...
      >
        <img
          data-src="wavechat.png"
          alt="WaveChat logo"
          width="96"
          height="96"
          class="w-24 lozad"
        />
        <span class="mt-1">WaveChat logo</span>
      </div>

      <h3 class="my-2 text-lg font-semibold text-center">My Github</h3>
      <p>
