    ...
    >
      <ContentCard>
        ...
        <div class="w-full">
          ...
          <button type="button" class="mt-8 mb-4">
            <a :href="mail" class="btn-primary">Send It</a>
          </button>
        </div>
      </ContentCard>
      ...
      <ContentCard>
        ...
        <div class="grid grid-cols-3 gap-x-4 gap-y-2">
          ...
          >
            <span class="sr-only">My Instagram profile</span>
            <NuxtImg
          ...
          <a
            href="https://www.linkedin.com/in/tim-thuma/"
            target="_blank"
            rel="noopener noreferrer"
          >
...
const mail = computed(() => 
  `mailto:thumatim@gmail.com?subject=Hello there!&body=${message.value}`
)
</script>
